...
$hour_price = homey_get_experience_data('hour_price');
$weekends_price = homey_get_experience_data('hourly_weekends_price');
$weekends_days = homey_get_experience_data('weekends_days');
$min_book_hours = homey_get_experience_data('min_book_hours');
$security_deposit = homey_get_experience_data('security_deposit');
$cleaning_fee = homey_get_experience_data('cleaning_fee');
$cleaning_fee_type = homey_get_experience_data('cleaning_fee_type');
$city_fee = homey_get_experience_data('city_fee');
$city_fee_type = homey_get_experience_data('city_fee_type');
$additional_guests_price = homey_get_experience_data('additional_guests_price');
$allow_additional_guests = homey_get_experience_data('allow_additional_guests');
            ...
            <div class="block-body">
                ...
                <div class="block-right">
                    <ul class="detail-list detail-list-2-cols">
                        ...
                        <li>
                            <i class="homey-icon homey-icon-arrow-right-1" aria-hidden="true"></i>
                            <?php echo esc_attr(homey_option('experience_sn_security_deposit_label'));?>:
                        ...
                        <li>
                            <i class="homey-icon homey-icon-arrow-right-1" aria-hidden="true"></i>
                            <?php echo esc_attr(homey_option('experience_sn_addinal_guests_label'));?>:
                        ...
                        <li>
                            <i class="homey-icon homey-icon-arrow-right-1" aria-hidden="true"></i>
                            <?php echo esc_attr(homey_option('experience_sn_allow_additional_guests'));?>:
                        ...
                        <li>
                            <i class="homey-icon homey-icon-arrow-right-1" aria-hidden="true"></i>
                            <?php echo esc_attr(homey_option('experience_sn_cleaning_fee'));?>:
                        ...
                        <li>
                            <i class="homey-icon homey-icon-arrow-right-1" aria-hidden="true"></i>
                            <?php echo esc_attr(homey_option('experience_sn_city_fee'));?>:

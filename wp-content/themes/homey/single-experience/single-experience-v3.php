...
$booking_or_contact = homey_get_experience_data('booking_or_contact');
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <?php get_template_part('single-experience/top-gallery-full-width'); ?>
            </div>
        </div>
    </div>
</section><!-- header-area -->
                        ...
                        foreach ($layout_order as $key=>$value) {
                            ...
                            switch($key) {
                                ...
                                case 'instagram_feeds':
                                    get_template_part('single-experience/instagram_feeds');
                                break;

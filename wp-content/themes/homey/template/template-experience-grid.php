<?php
/**
 * Template Name: Experiences Grid View
 */ 
get_header();
...
<section class="main-content-area experiences-listing-page listing-page <?php echo $full_width_class; ?>">
    ...
    <div data-section="posts"  class="container">
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <div id="experiences_module_section" class="listing-wrap item-grid-view">

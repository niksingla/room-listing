<?php
/**
 * Template Name: Listings List View v2
 */
get_header();
global $post, $paged, $listing_founds, $number_of_listings, $homey_prefix, $template_args;
    ...
    <div class="container">
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <div id="listings_module_section" class="listing-wrap item-list-view item-list-view-v2">

...
$total_available_experiences = isset($membership_package_meta['hm_settings_experiences_included'][0]) ? $membership_package_meta['hm_settings_experiences_included'][0] : 0 ;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="wallet-box">
                                            ...
                                            <div class="wallet-box-info mb-0"><?php echo esc_html__('Remaining experiences:', 'homey'); ?> <strong><?php echo $total_available_experiences - esc_attr($author['publish_experience_count'])?></strong> </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="wallet-box">
                                            ...
                                            <div class="wallet-box-info mb-0"><?php echo esc_html__('Remaining featured experiences:', 'homey'); ?> <strong><?php echo $total_available_featured_experiences - esc_attr($author['all_featured_experience_count']); ?></strong> </div>
                                        </div>
                                    </div>
                                </div>
                                <!--End Experience-->

<?php
/**
 * Template Name: Experiences List View
 */
get_header();
global $post, $paged, $experience_founds, $number_of_experiences, $homey_prefix, $template_args;
    ...
    <div class="container">
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <div id="experiences_module_section" class="listing-wrap item-list-view">

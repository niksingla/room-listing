...
$listing_total_number_of_reviews = get_post_meta( get_the_ID(), 'listing_total_number_of_reviews', true );
$listing_rating = homey_get_review_stars($total_rating, false, true, true, $listing_total_number_of_reviews);
...
<div class="item-wrap <?php echo __( $template_args['listing-item-view'] ) ?> infobox_trigger homey-matchHeight"  data-dir="listing-card"  data-id="<?php echo $post->ID; ?>">

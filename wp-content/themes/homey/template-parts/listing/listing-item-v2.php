...
?>
<div class="item-wrap <?php echo esc_attr($template_args['listing-item-view']); ?> infobox_trigger homey-matchHeight" data-dir="listing-item" data-id="<?php echo $post->ID; ?>">
...
<!--            <div class="item-title-head table-block"> below want to remove class tabe-block-->
            ...
            <ul class="item-amenities">
                ...
                <li>
                    <?php echo ''.$bedrooms_icon; ?><span class="total-beds"><?php echo esc_attr($bedrooms); ?></span> <span class="item-label"><?php echo esc_attr(homey_option('glc_bedrooms_label'));?></span>
                </li>
                <?php } ?>

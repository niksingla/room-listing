...
$listings_included = !empty($unlimited_listings) ? esc_html__('Unlimited Listings', 'homey'): $listings_included;
...
<div class="price-table-module featured">
    ...
    <div class="price-table-price-wrap">
        <?php echo membership_currency_table($currency, $package_price, ','); //$package_price;  ?>
    ...
    <div class="price-table-description">
        <ul class="list-unstyled">
            ...
            <li>
                <i class="homey-icon homey-icon-check-circle-1" aria-hidden="true"></i> <?php esc_html_e('Listings', 'homey'); ?>: <strong><?php echo esc_attr($unlimited_listings) == 'on' ? esc_html__('Unlimited Listings', 'homey') : esc_attr($listings_included); ?></strong>
            </li>
            <li>
            ...
            <!--Experiences-->
            <li>
                <i class="homey-icon homey-icon-check-circle-1" aria-hidden="true"></i> <?php esc_html_e('Experiences', 'homey'); ?>: <strong><?php echo esc_attr($unlimited_experiences) == 'on' ? esc_html__('Unlimited Experience', 'homey') : esc_attr($experiences_included); ?></strong>
            </li>
            <li>

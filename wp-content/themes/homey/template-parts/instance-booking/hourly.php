                        ...
                        <div class="block-body homey-booking-block-body-3" style="display: none;">
                            ...
                            <?php if( homey_is_woocommerce() ) { ?>
                                ...
                                <div id="without_stripe" class="continue-block-button">
                                    ...
                                    <input type="hidden" id="check_in_hour" value="<?php echo esc_attr($check_in_hour); ?>">
                                    <input type="hidden" id="check_out_hour" value="<?php echo esc_attr($check_out_hour); ?>">
                                    ...
                                    <button id="make_hourly_woocommerce_instant_booking_payment" type="button" class="btn btn-booking btn-full-width"><?php echo esc_attr($homey_local['btn_process_pay']); ?></button>
                            ...
                            <form name="homey_checkout" method="post" class="homey_payment_form" action="<?php echo esc_url($stripe_processor_link); ?>">
                                ...
                                <div id="without_stripe" class="continue-block-button">
                                    ...
                                    <input type="hidden" id="listing_id" value="<?php echo intval($listing_id); ?>">
                                    <input type="hidden" name="checkout-security" id="checkout-security" value="<?php echo wp_create_nonce('checkout-security-nonce'); ?>"/>
                                    <button id="make_hourly_instance_booking_payment" type="button" class="btn btn-booking btn-full-width"><?php echo esc_attr($homey_local['btn_process_pay']); ?></button>
                                    <div id="instance_noti"></div>
                                </div>
                            </form>
                            <?php } ?>

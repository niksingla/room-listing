...
?>
<div class="half-map-exp-search half-map-search main-search-wrap side-search-experiences">
    <div class="container-fluid">
        <div class="search-wrap hidden-xs">
            <form class="clearfix">
                ...
                <?php if( homey_option('enable_radius_exp') ) { ?>
                <?php $radius_unit = homey_option('radius_unit_exp'); ?>
                ...
                <div class="half-map-search-buttons">
                    ...
                    <button type="button" class="btn btn-grey-outlined hidden-xs" data-toggle="collapse" data-target="#half-map-search-collapse-exp" aria-expanded="false" ><i class="homey-icon homey-icon-settings-slider" aria-hidden="true"></i></button>
                    <button type="button" class="btn btn-grey-outlined visible-xs" data-toggle="collapse" data-target="#half-map-search-collapse-exp" aria-expanded="false"><?php echo esc_attr($homey_local['adv_btn']); ?></button>
                    <?php } ?>
                    
                    <button type="button" class="homey_half_map_exp_search_btn btn btn-primary"><?php echo esc_attr($homey_local['search_btn']); ?></button>
                </div>
            </form>
        </div><!-- search-wrap -->
        ...
        <div class="search-wrap search-banner-mobile mobile-search-exp-js">
            <form class="clearfix">
                <div class="search-destination">
                    <input value="<?php echo esc_attr($location_search); ?>" type="text" class="form-control" placeholder="<?php echo esc_attr(homey_option('srh_whr_to_go_exp')); ?>" onfocus="blur();">
                </div>
            </form>
        </div><!-- search-wrap -->      
    </div>
</div>
<div class="collapse half-map-search-filters" id="half-map-search-collapse-exp">
    <?php get_template_part ('template-parts/search/search-filter-full-width-exp'); ?>
</div>
        ...
        <div class="search-wrap search-banner">
            <form class="clearfix" action="<?php echo homey_get_search_result_exp_page(); ?>" method="GET">
                ...
                if( (int) $advanced_filter != 0 ) { ?>
                    <button type="button" class="btn btn-grey-outlined search-filter-mobile-btn"><i class="homey-icon homey-icon-settings-slider" aria-hidden="true"></i> <?php esc_html_e('Advanced', 'homey'); ?></button>

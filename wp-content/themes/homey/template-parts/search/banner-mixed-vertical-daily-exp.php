...
?>
<div class="tab-pane" id="banner-mixed-vertical-daily-exp">
    <div class="search-wrap search-banner search-banner-desktop side-search hidden-xs side-search-experiences">
                    ...
                    switch($key) { 
                        ...
                        case 'guests':
                            ...
                            <div class="search-guests search-guests-js">
                                <label class="animated-label"><?php echo esc_attr(homey_option('srh_guests_label_exp')); ?></label>
    ...
    <div class="search-wrap search-banner search-banner-mobile mobile-search-exp-js">
        <form class="clearfix">

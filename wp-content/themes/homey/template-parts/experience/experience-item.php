...
if(is_null($template_args)){
    ...
    $listing_item_view = $template_args['listing-item-view'];
}
...
<div class="item-wrap <?php echo __( $listing_item_view ) ?> experience-wrap infobox_trigger homey-matchHeight"  data-id="<?php echo $post->ID; ?>">

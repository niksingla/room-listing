                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="dashboard-area">
                        ...
                        <div class="block">
                            ...
                            get_template_part('template-parts/dashboard/reservation-experiences/add-extra-expenses');
                        ...
                        <div class="payment-buttons visible-md visible-sm visible-xs">
                            <?php homey_exp_reservation_action($reservation_status, $upfront_payment, $payment_link, $reservationID, 'btn-half-width'); ?>
                        </div>
                    </div><!-- .dashboard-area -->

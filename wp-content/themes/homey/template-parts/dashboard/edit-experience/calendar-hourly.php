<?php 
global $homey_local, $edit_experience_id;
...
$min_book_hours  = homey_get_experience_data_by_id('min_book_hours', $edit_experience_id);
...
<div id="calendar-tab" style="visibility: <?php echo esc_attr($visisblty); ?>;" class="tab-pane11 fade <?php echo esc_attr($class); ?>">
    ...
    <div class="block-body">
        <div id="property-calendar" class="property-calendar">
            ...
            <div id="homey_hourly_calendar_edit_experience"></div>

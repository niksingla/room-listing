                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="experience_type" class="selectpicker"
                            ...
                            <?php homey_get_taxonomies_for_edit_listing($experience_data->ID, 'experience_type'); ?>
                        </select>
                    </div>
                </div>
            <?php } ?>
                ...
                if (!empty($fields_array)) {
                    foreach ($fields_array as $value) {
                        ...
                        if ($field_type == 'select') {
                            ...
                            if (isset($hide_fields['experience_' . $field_name]) && $hide_fields['experience_' . $field_name] != 1) {

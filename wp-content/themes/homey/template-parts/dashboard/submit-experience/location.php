            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="false" name="aptSuit" <?php homey_required('experience_aptSuit'); ?> class="form-control" id="experience_aptSuit" placeholder="<?php echo esc_attr(homey_option('experience_ad_aptSuit_placeholder')); ?>">
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="false" data-input-title="<?php echo esc_html__(esc_attr(homey_option('experience_ad_city')), 'homey'); ?>" name="locality" id="experience_city" <?php homey_required('experience_city'); ?> class="form-control" placeholder="<?php echo esc_attr(homey_option('experience_ad_city_placeholder')); ?>">
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="false" name="administrative_area_level_1" id="experience_state"  class="form-control" <?php homey_required('experience_state'); ?> placeholder="<?php echo esc_attr(homey_option('experience_ad_state_placeholder')); ?>">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="false" name="zip" <?php homey_required('experience_zip'); ?> class="form-control" id="experience_zip" placeholder="<?php echo esc_attr(homey_option('experience_ad_zipcode_placeholder')); ?>">
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" autocomplete="false" name="neighborhood" id="experience_area" <?php homey_required('experience_area'); ?> placeholder="<?php echo esc_attr(homey_option('experience_ad_area_placeholder')); ?>">
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" autocomplete="false" name="country" id="experience_homey_country" <?php homey_required('experience_country'); ?> placeholder="<?php echo esc_attr(homey_option('experience_ad_country_placeholder')); ?>">

    ...
    <div class="block">
        <div class="block-title">
            <div class="block-left">
                <h2 class="title"><?php echo esc_attr(homey_option('experience_ad_features')); ?></h2>
            </div><!-- block-left -->
        </div>
                    ...
                    if (!empty($amenities)) {
                        ...
                        foreach ($amenities as $amenity) {
                            echo '<label class="control control--checkbox">';
                                echo '<input type="checkbox" name="amenity[]" id="amenity-' . esc_attr( $amenity->slug ). '" value="' . esc_attr( $amenity->term_id ). '">';
                ...
                <div class="house-features-list">
                    ...
                    if (!empty($facilities)) {
                        ...
                        foreach ($facilities as $facility) {
                            echo '<label class="control control--checkbox">';
                                echo '<input type="checkbox" name="facility[]" id="facility-' . esc_attr( $facility->slug ). '" value="' . esc_attr( $facility->term_id ). '">';

    ...
    if ( typeof HOMEY_map_vars !== "undefined" ) {
        ...
        *---------------------------------------------------------------------------*/
        ...
        if (document.getElementById('experience_address') || document.getElementById('experience_address')) {
            ...
            if (document.getElementById('homey_edit_map')) {
                ...
                google.maps.event.addListener(marker, 'dragend', function(evt) {
                    document.getElementById('experience_lat').value = this.getPosition().lat();
                    document.getElementById('experience_lng').value = this.getPosition().lng();
                });
        ...
        function homey_geocodeAddress(geocoder, resultsMap, marker) {
            var lat = document.getElementById('experience_lat').value;
            var lng = document.getElementById('experience_lng').value;
            ...
            geocoder.geocode({'location': latlng}, function(results, status) {
                if (status === 'OK') {
                    ...
                    document.getElementById('experience_lat').value = results[0].geometry.location.lat();
                    document.getElementById('experience_lng').value = results[0].geometry.location.lng();
        ...
        function fillInAddress_for_form(place) {
            ...
            document.getElementById('experience_lat').value = place.geometry.location.lat();
            document.getElementById('experience_lng').value = place.geometry.location.lng();

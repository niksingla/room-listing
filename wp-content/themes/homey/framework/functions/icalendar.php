    ...
    function homey_get_booked_dates_for_icalendar($listing_id) {
        ...
        if ($wpQry->have_posts()) {
            ...
            while ($wpQry->have_posts()): $wpQry->the_post();
                ...
                $return_feeds .= homey_generate_ical_event($check_in_start, $check_out_end, $listing_id, $reservation_id);
...
function ical_test()
{
    ...
    $feed_url = "https://outlook.live.com/owa/calendar/2727c79b-3a22-4d92-a55c-f5af7f1851ec/f799737b-a948-4f2f-b7b9-853d137d967d/cid-B326C0B75C5C3CD4/calendar.ics";
    ...
    if (is_array($booked_dates_array) || is_object($booked_dates_array)) {
        ...
        echo ' testoung ';
//            print_r($booked_dates_array);

        print_r($events_data_to_unset);
        exit;

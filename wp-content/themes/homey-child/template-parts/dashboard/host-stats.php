...
<div class="block">
    ...
    <div class="block-verify">
        <div class="block-col <?php echo esc_attr($block_class); ?>">
            ...
            <a href="<?php echo esc_url($submission_page_link); ?>"><?php esc_html_e('Neue hinzufügen', 'homey'); ?></a>
        </div>
        <div class="block-col <?php echo esc_attr($block_class); ?>">
            <h3><?php echo esc_attr($homey_local['pr_resv_label']); ?></h3>
            <p class="block-big-text"><?php echo homey_reservation_count($userID); ?></p>
            <a href="<?php echo esc_url($reservation_page_link); ?>"><?php esc_html_e('Verwalten', 'homey'); ?></a>
        </div>
        ...
        <div class="block-col <?php echo esc_attr($block_class); ?>">
            <h3><?php 
                ...
                if(!homey_is_renter())
                $earnings_label ='Verdienste';
                esc_html_e($earnings_label, 'homey'); 
            ?></h3>
            ...
            <a href="<?php echo esc_url($wallet_page_link); ?>"><?php esc_html_e('Geldbörse', 'homey'); ?></a>
        </div>
        <?php } ?>
    </div>

...
if( !function_exists('homey_get_localization')) {
	function homey_get_localization() {
		...
		$localization = array(
			...
			'welcome_back_text' => !homey_is_renter() ? esc_html__('Willkommen zurück,', 'homey') : esc_html__('Welcome Back,', 'homey'),
			...
			*------------------------------------------------------*/
			...
			'm_add_listing_label' => esc_html__('Neue hinzufügen', 'homey' ),
			...
			'm_favorites_label' => !homey_is_renter() ? esc_html__('Favoriten', 'homey' ) : esc_html__('Favorites', 'homey' ),
			'm_invoices_label' => !homey_is_renter() ? esc_html__('Rechnungen', 'homey' ) : esc_html__('Invoices', 'homey' ),
			'm_messages_label' => !homey_is_renter() ? esc_html__('Mitteilungen', 'homey') : esc_html__('Messages', 'homey' ),

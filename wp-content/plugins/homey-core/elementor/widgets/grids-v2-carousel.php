 ...
 * @since 1.0.1
 */
class Homey_Elementor_Grids_v2_Carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'homey_elementor_grids_v2_carousel';
    }
    ...
    public function get_title() {
        return esc_html__( 'Homey Grids v2 Carousel', 'homey-core' );
    }
    ...
    protected function render() {
        ...
        if( function_exists( 'homey_grids_v2_carousel' ) ) {
            echo homey_grids_v2_carousel( $args );
        }
...
Plugin::instance()->widgets_manager->register( new Homey_Elementor_Grids_v2_Carousel );
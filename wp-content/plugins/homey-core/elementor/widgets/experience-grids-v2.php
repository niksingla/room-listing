 ...
 * @since 1.0.1
 */
class Homey_Elementor_Experience_Grids_v2 extends Widget_Base {
    ...
    public function get_name() {
        return 'homey_elementor_experience_grids_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Experience Grids v2', 'homey-core' );
    }
    ...
    protected function render() {
        ...
        if( function_exists( 'homey_experience_grids_v2' ) ) {
            echo homey_experience_grids_v2( $args );
        }
...
Plugin::instance()->widgets_manager->register_widget_type( new Homey_Elementor_Experience_Grids_v2 );
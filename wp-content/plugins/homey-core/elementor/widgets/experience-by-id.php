...
/**
 * Elementor Experience by ID Widget.
 * @since 1.0.1
 */
class Homey_Elementor_experience_By_ID extends Widget_Base {
    ...
    public function get_name() {
        return 'homey_elementor_exp_property_by_id';
    }
    ...
    public function get_title() {
        return esc_html__( 'Experience by ID', 'homey-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'experience_id',
            [
                'label'     => esc_html__( 'Experience ID', 'homey-core' ),
                'type'      => Controls_Manager::TEXT,
                'description'   => esc_html__( 'Enter the experience ID. Example 59208', 'homey-core' ),
            ]
        );
    ...
    protected function render() {
        ...
        $args['experience_id']     =  $settings['experience_id'];
       
        if( function_exists( 'homey_experience_by_id' ) ) {
            echo homey_experience_by_id( $args );
        }
...
Plugin::instance()->widgets_manager->register( new Homey_Elementor_experience_By_ID );
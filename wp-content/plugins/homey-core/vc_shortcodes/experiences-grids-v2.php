...
/*	Module 1
/*-----------------------------------------------------------------------------------*/
if( !function_exists('homey_experience_grids_v2') ) {
	function homey_experience_grids_v2($atts, $content = null)
	{
	...
	add_shortcode('homey-experience-grids-v2', 'homey_experience_grids_v2');
}
?>